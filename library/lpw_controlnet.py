# copy from https://github.com/huggingface/diffusers/blob/main/src/diffusers/pipelines/controlnet/pipeline_controlnet.py
...
class StableDiffusionControlNetPipeline(StableDiffusionLongPromptWeightingPipeline):
    r"""
